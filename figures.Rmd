...
```{r well-map-CO, cache = TRUE, fig.cap = "Spatial Distributions of Wells Used in Empirical Analysis", results = "hide"}
#/*=================================================*/
#' # Well Locations
#/*=================================================*/
# /*----------------------------------*/
#' ## State borders
# /*----------------------------------*/
CO_state <- st_read(dsn = here("Data/Geographic/US_States"), "states") %>%
...
# /*----------------------------------*/
#--- CO counties ---#
CO_sf <- st_read(dsn = here("Data/Geographic/County"), "Colorado_County_Boundaries") %>%
  st_transform(4269) %>%
...
```{r etw-pc-gpm, cache = TRUE, fig.cap = "Heterogeneity of Energy Use Efficiency and Pumping Costs (All Years)", results = "hide"}
#/*=================================================*/
...
```{r af-wy, fig.cap = "The relationship between water use and well yield", results = "hide"}
#/*=================================================*/
...
```{r pc-vs-wy, fig.cap = "The relationship between pumping cost and well yield", results = "hide"}
#/*=================================================*/

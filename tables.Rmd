```{r summary-stat, cache=TRUE, tab.cap = "Summary Statistics"}
#/*=================================================*/
...
```{r eprice-schedule, tab.cap = "Energy Price: Block Rate Structure"}
#/*=================================================*/
...
```{r FE-results-NE, dependson = "regression_results", tab.cap = "The impacts of pumping costs on groundwater extraction for irrigation"}
...
```{r FE-results-NE-rob, dependson = "regression_results", tab.cap = "Regression results with more accurate saturated thickness using selected samples"}
